          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-800">
              {filteredProducts.map((p) => {
                ...
                if (p.current_stock === 0) {badgeClass = 'bg-red-500/20 text-red-400';statusText = 'Out of Stock';} else
                if (p.current_stock < 15) {badgeClass = 'bg-orange-500/20 text-orange-400';statusText = 'Low';}
